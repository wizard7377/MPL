// cllang.hpp generated by reflex 3.3.5 from grams/cllang.ll

#ifndef REFLEX_CLLANG_HPP
#define REFLEX_CLLANG_HPP
#define IN_HEADER 1
...
class Scanner : public reflex::AbstractLexer<reflex::Matcher> {
 public:
  ...
  virtual cl::parser::symbol_type yylex(void);
  void perf_report()
  {
    if (perf_report_time_pointer != NULL)
      *perf_report_time_pointer += reflex::timer_elapsed(perf_report_timer);
    std::cerr << "reflex 3.3.5 grams/cllang.ll performance report:\n";
    std::cerr << "  INITIAL rules matched:\n"
      "    rule at line 29 matched " << perf_report_INITIAL_rule[0] << " times, matching " << perf_report_INITIAL_size[0] << " bytes total in " << perf_report_INITIAL_time[0] << " ms\n"
      "    rule at line 30 matched " << perf_report_INITIAL_rule[1] << " times, matching " << perf_report_INITIAL_size[1] << " bytes total in " << perf_report_INITIAL_time[1] << " ms\n"
      "    rule at line 31 matched " << perf_report_INITIAL_rule[2] << " times, matching " << perf_report_INITIAL_size[2] << " bytes total in " << perf_report_INITIAL_time[2] << " ms\n"
      "    rule at line 32 matched " << perf_report_INITIAL_rule[3] << " times, matching " << perf_report_INITIAL_size[3] << " bytes total in " << perf_report_INITIAL_time[3] << " ms\n"
      "    rule at line 33 matched " << perf_report_INITIAL_rule[4] << " times, matching " << perf_report_INITIAL_size[4] << " bytes total in " << perf_report_INITIAL_time[4] << " ms\n"
      "    rule at line 34 matched " << perf_report_INITIAL_rule[5] << " times, matching " << perf_report_INITIAL_size[5] << " bytes total in " << perf_report_INITIAL_time[5] << " ms\n"
      "    rule at line 36 matched " << perf_report_INITIAL_rule[6] << " times, matching " << perf_report_INITIAL_size[6] << " bytes total in " << perf_report_INITIAL_time[6] << " ms\n"
      "    rule at line 39 matched " << perf_report_INITIAL_rule[7] << " times, matching " << perf_report_INITIAL_size[7] << " bytes total in " << perf_report_INITIAL_time[7] << " ms\n";
 ...
 protected:
  size_t perf_report_INITIAL_rule[8];
  size_t perf_report_INITIAL_size[8];
  float  perf_report_INITIAL_time[8];
